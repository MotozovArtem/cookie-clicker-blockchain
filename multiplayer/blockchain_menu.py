...
from multiplayer.models.Miner import Miner, SuccessException


class StartWindow(QtWidgets.QMainWindow):

    def __init__(self, miner, client, parent=None):  # Сюда надо будет передать окно синглплеера
    ...
    def show_info(self):
        dialog = InfoDialog(self.label, "Info",
                            "A blockchain - a continuously growing list of records, called blocks, "
